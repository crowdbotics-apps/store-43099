"""
Django settings for store_43099 project.
...
WSGI_APPLICATION = 'store_43099.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "store_43099 API",
    "DESCRIPTION": "API documentation for store_43099 App",
    "VERSION": "v1",
}
